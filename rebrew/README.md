...
Rebrew is an **ordinary desktop window**: other applications cover it normally.
...
([`.github/workflows/rebrew.yml`](../.github/workflows/rebrew.yml)), which is also
...
- **macOS** refuses to open it at all on a double-click. Right-click the app →
  **Open** → **Open**, or run `xattr -dr com.apple.quarantine /Applications/Rebrew.app`.
...
rebrew/
  src/
    ...
    Info.tsx          what Rebrew is, and what it does not do
...
Rebrew does not read or store your chats. Recipes and preferences stay on this
