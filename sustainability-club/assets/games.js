/* ===========================================================
   UBT Sustainability Club — mini-games
...
(function () {
  ...
  var gameTurtle = {
    ...
    emoji: '🐢',
    tagline: 'Clear the plastic before it reaches her.',
  ...
  var gameRace = {
    ...
    name: 'Eco Race',
    emoji: '🏁',
    tagline: 'Beat the smoky old rival to the line.',
  ...
  var gameBin = {
    ...
    name: 'Bin It',
    emoji: '♻️',
    tagline: 'Five items, three bins, no thinking time.',
  ...
  var gameCook = {
    ...
    emoji: '🌍',
    tagline: 'Absolutely no knowledge required.',
  ...
  var gameDrop = {
    ...
    name: 'Drop Catch',
    emoji: '💧',
    tagline: 'Every drop counts. The trash does not.',
    ...
    start: function (api) {
      ...
      rt.frame(function (dt) {
        ...
        g.addColorStop(1, '#CFE6F7');
        ctx.fillStyle = g;
        ctx.fillRect(0, 0, view.w, view.h);

        ctx.fillStyle = 'rgba(30,42,94,.07)';
  ...
  var gamePower = {
    ...
    name: 'Power UBT',
    emoji: '⚡',
    tagline: 'Three upgrades. One campus.',
  ...
  GAMES.forEach(function (g) {
    ...
    card.type = 'button';
    card.appendChild(el('span', 'game-emoji', g.emoji));
    card.appendChild(el('h3', 'game-name', g.name));
    card.appendChild(el('p', 'game-tag', g.tagline));
    card.appendChild(el('span', 'game-meta', 'Play'));
  ...
  function showIntro() {
    ...
    showCurtain('', [
      ...
      '<p>' + g.instruction + '</p>',
      '<div class="btn-row">',
      '<button class="btn btn-green" data-act="start">' + (g.startLabel || 'Start') + '</button>',
      '<button class="btn btn-ghost" data-act="back">Back to Games</button>',
      '</div>'
    ].join(''));
  }
  ...
  function showResult(won, detail) {
    showCurtain(won ? 'result-win' : 'result-lose', [
      ...
      '<p>' + (detail || '') + '</p>',
      '<div class="btn-row">',
      '<button class="btn btn-green" data-act="again">Play Again</button>',
      '<button class="btn btn-ghost" data-act="back">Back to Games</button>',
      '</div>'
    ].join(''));
  }
